...
bsDownloads="/home/mr_robot/Collection/BrokenStones/"
...
if [[ "$tracker" == *"myanonamouse.net"* ]]; then
    ...
    transmission-remote -t $TR_TORRENT_ID --labels [brokenstones]
    transmission-remote -t $TR_TORRENT_ID --move $bsDownloads
fi
